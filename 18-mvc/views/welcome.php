  ...
  <div class="hero bg-base-200 min-h-screen">
    <div class="hero-content text-center">
      <div class="max-w-md">
        ...
        <a href="views/add.php" class="btn btn-success my-4">
            ...
            <tbody>
              <?php foreach ($data as $pokemon): ?>
                <tr>
                  ...
                  <td>
                    <a href="/18-mvc/actions/pokemon_action.php?action=view&id=<?= $pokemon['id'] ?>" class="btn btn-xs btn-neutral"><svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="currentColor" viewBox="0 0 256 256">
                        <path d="M229.66,218.34l-50.07-50.06a88.11,88.11,0,1,0-11.31,11.31l50.06,50.07a8,8,0,0,0,11.32-11.32ZM40,112a72,72,0,1,1,72,72A72.08,72.08,0,0,1,40,112Z"></path>
                      </svg></a>
                    <a href="/18-mvc/actions/pokemon_action.php?action=edit&id=<?= $pokemon['id'] ?>" class="btn btn-xs btn-neutral"><svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="currentColor" viewBox="0 0 256 256">
                        <path d="M227.31,73.37,182.63,28.68a16,16,0,0,0-22.63,0L36.69,152A15.86,15.86,0,0,0,32,163.31V208a16,16,0,0,0,16,16H92.69A15.86,15.86,0,0,0,104,219.31L227.31,96a16,16,0,0,0,0-22.63ZM92.69,208H48V163.31l88-88L180.69,120ZM192,108.68,147.31,64l24-24L216,84.68Z"></path>
                      </svg></a>
                    <a href="/18-mvc/actions/pokemon_action.php?action=delete&id=<?= $pokemon['id'] ?>" class="btn btn-xs btn-error"><svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="currentColor" viewBox="0 0 256 256">
